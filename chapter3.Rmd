...
```{r fig12, fig.path="figures/",fig.dim=c(10,10)}
...
The model predict correctly in 270 cases.However, the model does not predict any high users so the model is not reliable. Basically it is as reliable as always guess that the student is never a high-alc-user. 
```{r datastructure 6}
